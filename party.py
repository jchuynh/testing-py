...
def is_mel(name, email):
    ...
    True
    >>> is_mel('Mel Melitpolski', 'melly@ubermelon.com')
    True
    >>> is_mel('The Mel Melitpolski', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'appetizer'}, {'type': 'appetizer'}, {'type': 'drink'}])
    ('appetizer', 'drink')
    ...
    >>> most_and_least_common_type([{'type': 'drink'}, {'type': 'drink'}, {'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'dessert'}])
    ('drink', 'appetizer')
